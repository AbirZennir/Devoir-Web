...
<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 250px; height: 100vh;">
  ...
  <ul class="nav nav-pills flex-column mb-auto">
   <c:choose>
    ...
    <c:when test="${user.role == 'TEACHER'}">
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/teacher/dashboard" class="nav-link text-white">
                <i class="bi bi-speedometer2"></i> Tableau de bord
            </a>
        </li>
    </c:when>
    <c:when test="${user.role == 'STUDENT'}">
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/student/dashboard" class="nav-link text-white">
                <i class="bi bi-speedometer2"></i> Tableau de bord
            </a>
        </li>
    </c:when>
    ...
    <c:if test="${user.role == 'TEACHER'}">
    <li>
        <a href="${pageContext.request.contextPath}/teacher/assignments/create" class="nav-link text-white">
            ➕ Créer un devoir
        </a>
    </li>
</c:if>
    ...
    <c:if test="${user.role == 'STUDENT'}">
      ...
      <li>
        <a href="/user/notes" class="nav-link text-white d-flex justify-content-between align-items-center">
          Mes Notes
  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
      ...
      <c:if test="${user.role == 'TEACHER'}">
        <li><a class="dropdown-item" href="${pageContext.request.contextPath}/teacher/assignments/create">Créer un devoir</a></li>
      </c:if>
