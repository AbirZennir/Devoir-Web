  ...
  <ul class="nav nav-pills flex-column mb-auto">
    <c:choose>
      <c:when test="${user.role == 'ADMIN'}">
        ...
        <li><a href="${pageContext.request.contextPath}/admin/users" class="nav-link text-white">👤 Utilisateurs</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/courses" class="nav-link text-white">📚 Cours</a></li>
      </c:when>
      ...
      <c:when test="${user.role == 'STUDENT'}">
        <li><a href="${pageContext.request.contextPath}/student/dashboard" class="nav-link text-white"><i class="bi bi-speedometer2"></i> Tableau de bord</a></li>
        <li><a href="${pageContext.request.contextPath}/user/assignments" class="nav-link text-white">📄 Mes Devoirs</a></li>
        <li>
